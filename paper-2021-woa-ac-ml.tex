...
%
For this reason, over the years, various approaches have addressed the problem of dealing with this complexity---for instance, by taking inspiration from natural systems like insect and animal societies (e.g., ant colonies, bee hives, flocks of birds etc.). 
%
...
Initially, researchers had tried to build systems that show these properties in computing systems by mimickng natural collective behaviours ``from the bottom up''~\cite{DBLP:journals/connection/Webb02}, 
...
Instead, reward function might be dependent on the learning technique, time, and problem. 
...
In a case study, we have empirically showed the effectiveness of RL by showing a speed up of the convergence time of
 aggregate program we took into consideration, namely the hop count.
