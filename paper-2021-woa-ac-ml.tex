...
\todo[inline, color=yellow]{I do not know if we can avoid it altogether, but also a brief description of machine learning approaches can be usefull in the paper flow}
\todo[inline, color=cyan]{Outline}
