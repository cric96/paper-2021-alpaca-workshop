...
Artificial intelligence is here to stay. 
 In particular, in recent years, Machine Learning techniques have outperformed 
...
Therefore, with this work, we propose a solution that can be seen as the first step towards the integration between Aggregate Computing and Machine Learning, and, in particular Reinforcement Learning. 
 The goal is to improve adaptivity through low-level specifications but maintaining high-level program behaviours. 
 
In this work, we outline issues, opportunities and methodologies of this integration, presenting a case study where Aggregate Computing is successfully combined with Hysteretic Q-Learning.
%
...
\begin{figure*}
  ...
  \end{subfigure}
  \caption{Analysis of the learning process. \Cref{fig:simulation-a} shows the $total_{error}$ evolution during the learning process. \Cref{fig:simulation-b}, \Cref{fig:simulation-c}, and \Cref{fig:simulation-d} shows the average error in three different simulations with 80, 360 and 760 nodes. 
